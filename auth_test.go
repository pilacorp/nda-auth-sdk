...
func TestNewAuth(t *testing.T) {
	provider := provider.NewVaultProvider("https://vault-dev.pila.vn", "your-vault-token", 3)
...
func TestCreateToken(t *testing.T) {
	...
	token, err := a.CreateToken(context.Background(), vcJwts, "did:nda:testnet:0x2af7e8ebfec14f5e39469d2ce8442a5eef9f3fa4")
	if err != nil {
		fmt.Println(err)
